...
public class İdman {
    ...
    public void hareketYap(String hareketTuru,int sayi){
        ...
        else{ System.out.println("Gecersiz bir hareket girdiniz");
    }}
    public void burpeeYap(int sayi){
        if(burpee_sayisi==0){
            ...
            System.out.println("Hedeflediğiniz sayıyı gectiniz");
            burpee_sayisi=0;
     ...
     public void pushupYap(int sayi){
        if(pushup_sayisi==0){
            ...
            System.out.println("Hedeflediğiniz sayısı gectiniz");
            pushup_sayisi=0;
      ...
      public void situpYap(int sayi){
       ...
       public void squatYap(int sayi){
        if(squat_sayisi==0){
            ...
            System.out.println("Hedeflediginiz sayıyı gectiniz");
            squat_sayisi=0;
